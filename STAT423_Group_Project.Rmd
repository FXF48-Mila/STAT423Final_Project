...
# irrelated to smoke
data <- read.csv("Health_insurance.csv")
data_smoker <- data %>% filter(smoker == "yes")
data_smoker$smoker <- as.numeric(as.factor(data_smoker$smoker))
...
data_non_smoker <- data %>% filter(smoker == "no")
data_non_smoker$smoker <- as.numeric(as.factor(data_non_smoker$smoker))
