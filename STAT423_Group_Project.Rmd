...
In the following analysis, we performed Assumption Checks and Multicollinearity Checks several times. To minimize repetitive analytical writing, we used the list of conditions under which each assumption holds and referred to them as Assumption 1, 2, 3, and (not) having serious Multicollinearity issues.
