...
par(mfrow = c(1, 1), oma = c(0, 0, 0, 0))
```
Here, we fit a full model as `log_charges ~ age + sex + bmi + children + smoker + region` to see how personal information is related to the charges.
...
We worked together to review and organize the final report, streamlining it from 28 pages in the original draft to 10 pages. Everyone's contribution to the project was the same.
