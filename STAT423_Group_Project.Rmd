...
We can clearly see that there exist two regression lines in diagnostic plots for `age` and `charges`.
...
mtext("Figure 3: Boxcox Transformation on Health Insurance Charges", outer = TRUE, side = 1, line = 2, cex = 0.8, font = 3)
...
To improve our model performance and better satisfy our model assumption, we would consider to use residual bootstrap[@Chen2017].
