...
We can see the distribution of Health Insurance Charges is very right skewed. In order to fit the full regression model, we need a Box-Cox transformation.
...
histogram(log_charges, xlab = "Log Health Insurance Charges", main = "The Histogram for Log Health Insurance Charges")
